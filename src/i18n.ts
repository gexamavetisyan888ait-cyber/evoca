    ...
    am: {
        translation: {
            ...
            partners_section: {
                ...
                title: "Հաշիվներ",
                online_title: "Evoca\nOnline",
                online_desc: "Կառավարի՛ր հաշիվներդ աշխարհի ցանկացած կետից:"
            }, announcements_page: {
                ...
                title_part1: "Դարձիր Evocabank-ի հաճախորդ",
                title_part2: "բիոմետրիկ նույնականացմամբ",
                description: "Սկանավորի՛ր QR կոդը, ներբեռնի՛ր EvocaTOUCH հարմարավետ հավելվածը, ստեղծի՛ր քո հաշիվը և ստացի՛ր քարտը",
            ...
            leasing: {
                ...
                table: {
                    currency: "Արժույթ",
                    currency_val: "ՀՀ դրամ, ԱՄՆ դոլար, Եվրո",
                    prepayment: "Կանխավճար",
                    prepayment_val: "Նվազագույնը 10%",
                    term: "Ժամկետ",
                    term_val: "6-72 ամիս",
                    rate: "Տոկոսադրույք",
                    term_month: "Ժամկետ (ամիս)",
                    rate_short: "Տոկոս",
                    term_short: "Ժամկետ",
                    prepayment_short: "Կանխավճար",
                    month_short: "ամիս"
                },
                evoca_main: {
                    desc: "Լիզինգի առարկան կարող է ձեռք բերվել ինչպես ՀՀ-ից, այնպես էլ արտերկրից՝ առաջնային և երկրորդային շուկաներից։",
                    objects_title: "Առարկաներ",
                    objects: ["Արտադրական սարքավորումներ", "Բժշկական սարքավորումներ", "Շինարարական տեխնիկա", "Արևային կայաններ"],
                    advantages_title: "Առավելություններ",
                    advantages: ["Առանց գրավի առկայության", "Առանց նոտարական ծախսերի", "ԱԱՀ-ի հաշվանցում"],
                    table_head: "Պայմաններ և սակագներ"
                },
                modernization: {
                    title: "Տնտեսության Արդիականացման ծրագիր",
                    date: "Գործելու է մինչև 31.12.2026թ.",
                    desc: "Լիզինգի տոկոսադրույքի սուբսիդավորումն իրականացվում է պետության կողմից։"
                },
                special_offers: {
                    logiq: {
                        title: "Լոջիք Գրուպ ՍՊԸ",
                        subtitle: "Հատուկ սակագներ Լոջիք Գրուպի հաճախորդների համար."
                    },
                    auto: {
                        title: "Ավտո Գելերի ՓԲԸ",
                        subtitle: "Բեռնատարների լիզինգ"
                    }
                }
            }, transfers: {
                title: "Փոխանցումներ",
                ...
                tabs: {
                    fast: "Արագ փոխանցումներ",
                    local: "Ներհանրապետական",
                    international: "Միջազգային",
                    card_to_card: "Քարտից քարտ",
                    evoca_touch: "EvocaTouch փոխանցումներ"
                },
                hero: {
                    fast_title: "Արագ դրամական <br/> փոխանցումներ",
                    fast_desc: "Ստացեք կամ ուղարկեք գումար վայրկյանների ընթացքում աշխարհի ցանկացած կետից:",
                    card_title: "Քարտից քարտ <br/> փոխանցումներ 24/7",
                    card_desc: "Կատարեք փոխանցումներ ցանկացած բանկի ArCa, Visa կամ Mastercard քարտերին:"
                },
                systems: {
                    title: "Վճարային համակարգեր",
                    moneygram: "MoneyGram",
                    intelexpress: "IntelExpress",
                    unistream: "Unistream",
            ...
            cards_page: {
                "title": "Քարտեր",
                "loading": "Բեռնվում է...",
                "not_found": "Քարտը չի գտնվել",
                "back_to_cards": "Վերադառնալ քարտերին",
                "order_card": "Պատվիրել քարտը",
                "other_cards": "Այլ",
                "cards_label": "Քարտեր",
                "details": "Մանրամասն",
                "filter_no_results": "Այս ֆիլտրով քարտեր չեն գտնվել",
                "tabs": {
                    "qarter": "Քարտեր",
                    "spasarkum": "Սպասարկում",
                    "social": "Սոցիալական"
                }
            }
            ,
            translation: {
                ...
                "tariffs": {
                    "tabs": {
                        "personal_loans": "Վարկեր ֆիզիկական անձանց",
                        "business_loans": "Վարկեր իրավաբանական անձանց",
                        "cards": "Միջնորդավճարների սակագներ",
                        "deposits": "Ավանդների սակագներ",
                        "archive": "Արխիվ"
                    },
                    "table_headers": {
                        "number": "#",
                        "feature": "Պայմանների անվանում",
                        "value": "Սակագին / Պայման"
                    },
                    "archive_section": {
                        "title": "Արխիվ",
                        "info_label": "Անհրաժեշտ տեղեկատվություն",
                        "download_package": "Ներբեռնել արխիվային փաթեթը (PDF)",
                        "docs_label": "Փաստաթղթեր",
                ...
                "deposit_amount": "Ներդրվող գումար",
                "annual_rate": "Տարեկան տոկոսադրույք",
                "term": "Ժամկետ",
                "deposit_term": "Ավանդի ժամկետ",
                "months": "ամիս",
                "days": "օր",
                "daily_interest": "Օրական կտրվածքով հաշվարկվող տոկոսագումար *",
                "total_gross": "Ավանդային պայմանագրի գործողության ընթացքում հաշվարկվող ընդհանուր տոկոսային եկամուտ",
                "total_net": "Ավանդային պայմանագրի գործողության ընթացքում հաշվարկվող փաստացի վճարվող զուտ տոկոսային եկամուտ",
                "tax_info": "Ներդրված ավանդի դիմաց ստացվող տոկոսագումարները հաշվվում են 10% եկամտային հարկի չափով:",
                "repayment_type": "Մարման ձև",
                "spring": "Զսպանակաձև",
                "annuity": "Անուիտետ",
                "calculate": "Հաշվել",
                "disclaimer": "Բոլոր հաշվարկները կրում են մոտավոր բնույթ և չեն հանդիսանում հրապարակային առաջարկ:",
                "results_title": "Վարկային հաշվիչի արդյունքներ",
                "amount": "Գումար",
                "total": "Ընդհանուր",
                "month": "Ամիս",
                "interest_amount": "Տոկոսագումար",
    ...
    en: {
        translation: {
            ...
            partners_section: {
                ...
                title: "Accounts",
                online_title: "Evoca\nOnline",
                online_desc: "Manage your accounts from anywhere in the world."
            }, announcements_page: {
                title: "Announcements",
                filter_from: "From",
                filter_to: "To",
            ...
            biometric: {
                title_part1: "Become an Evocabank customer",
                title_part2: "via biometric identification",
                description: "Scan the QR code, download the user-friendly EvocaTOUCH app, create your account and get your card",
                button: "Learn more"
            },
            leasing: {
                tabs: {
                ...
                table: {
                    currency: "Currency",
                    currency_val: "AMD, USD, EUR",
                    prepayment: "Prepayment",
                    prepayment_val: "Min 10%",
                    term: "Term",
                    term_val: "6-72 months",
                    rate: "Interest Rate",
                    term_month: "Term (month)",
                    rate_short: "Rate",
                    term_short: "Term",
                    prepayment_short: "Prepayment",
                    month_short: "mo"
                },
                evoca_main: {
                    desc: "Leasing items can be purchased from RA and abroad, from primary and secondary markets.",
                    objects_title: "Items",
                    objects: ["Production equipment", "Medical equipment", "Construction machinery", "Solar plants"],
                    advantages_title: "Advantages",
                    advantages: ["No collateral required", "No notary fees", "VAT offsetting"],
                    table_head: "Terms and rates"
                },
                modernization: {
                    title: "Economic Modernization Program",
                    date: "Valid until 31.12.2026",
                    desc: "Interest rate subsidization is provided by the state."
                },
                special_offers: {
                    logiq: {
                        title: "Logiq Group LLC",
                        subtitle: "Special rates for Logiq Group customers."
                    },
                    auto: {
                        title: "Auto Gallery CJSC",
                        subtitle: "Truck Leasing"
                    }
                }
            },
            transfers: {
                ...
                tabs: {
                    ...
                    evoca_touch: "EvocaTouch Transfers"
                },
                hero: {
                    fast_title: "Fast Money <br/> Transfers",
                    fast_desc: "Receive or send money within seconds from anywhere in the world.",
                    card_title: "Card to Card <br/> Transfers 24/7",
                    card_desc: "Make transfers to ArCa, Visa, or Mastercard cards of any bank."
                },
                systems: {
            ...
            cards_page: {
                ...
                "cards_label": "Cards",
                "details": "Details",
                "filter_no_results": "No cards found with this filter",
                "tabs": {
                    "qarter": "Cards",
                    "spasarkum": "Service",
                    "social": "Social"
            ...
            translation: {
                ...
                "tariffs": {
                    "tabs": {
                        ...
                        "cards": "Card Tariffs",
                        "deposits": "Deposit Tariffs",
                        "archive": "Archive"
                    },
                    "table_headers": {
                        "number": "#",
                        "feature": "Feature Name",
                        "value": "Tariff / Condition"
                    },
                    "archive_section": {
                        "title": "Archive",
                        "info_label": "Required Information",
                        "download_package": "Download Archive Package (PDF)",
            ...
            "calculator": {
                ...
                "deposit_amount": "Investment Amount",
                "annual_rate": "Annual Rate",
                "term": "Term",
                ...
                "total_gross": "Total interest income calculated during the deposit contract",
                "total_net": "Actual net interest income paid during the deposit contract",
                "tax_info": "Interest income from the deposit is subject to 10% income tax.",
                "repayment_type": "Repayment type",
                "spring": "Differentiated",
                "annuity": "Annuity",
                "calculate": "Calculate",
                "disclaimer": "All calculations are approximate and do not constitute a public offer.",
                "results_title": "Loan Calculator Results",
                "amount": "Amount",
                "total": "Total",
                "month": "Month",
    ...
    ru: {
        translation: {
            ...
            hashivner_page: {
                title: "Счета",
                online_title: "Evoca\nOnline",
                online_desc: "Управляйте своими счетами из любой точки мира."
            },
            announcements_page: {
                title: "Объявления",
                filter_from: "С",
            ...
            biometric: {
                title_part1: "Стань клиентом Evocabank-а",
                title_part2: "через биометрическую идентификацию",
                description: "Сканируй QR-код, скачай удобное приложение EvocaTOUCH, создай свой аккаунт и получи карту",
            ...
            leasing: {
                ...
                news: {
                    media_center: "Медиа центр",
                    latest_title_part1: "Последние",
                    latest_title_part2: "новости",
                ...
                leasing: {
                    ...
                    table: {
                        ...
                        prepayment_val: "Мин. 10%",
                        term: "Срок",
                        term_val: "6-72 месяцев",
                        rate: "Процентная ставка",
                        term_month: "Срок (мес.)",
                        rate_short: "Процент",
                        term_short: "Срок",
                        prepayment_short: "Предоплата",
                        month_short: "мес."
                    },
                    evoca_main: {
                        desc: "Предмет лизинга может быть приобретен как в РА, так и за рубежом, на первичном и вторичном рынках.",
                        objects_title: "Предметы",
                        objects: ["Производственное оборудование", "Медицинское оборудование", "Строительная техника", "Солнечные станции"],
                        advantages_title: "Преимущества",
                        advantages: ["Без залога", "Без нотариальных расходов", "Зачет НДС"],
                        table_head: "Условия и тарифы"
                    },
                    modernization: {
                        title: "Программа модернизации экономики",
                        date: "Действует до 31.12.2026г.",
                        desc: "Субсидирование процентной ставки по лизингу осуществляется государством."
                    },
                    special_offers: {
                        logiq: {
                            title: "ООО Лоджик Груп",
                            subtitle: "Специальные тарифы для клиентов Лоджик Груп."
                        },
                        auto: {
                            title: "ЗАО Авто Гэлери",
                            subtitle: "Лизинг грузовых автомобилей"
                        }
                    }
                },
                common: {
            ...
            transfers: {
                ...
                tabs: {
                    fast: "Быстрые переводы",
                    local: "Внутри страны",
                    international: "Международные",
                    card_to_card: "С карты на карту",
                    evoca_touch: "Переводы EvocaTouch"
                },
                hero: {
                    fast_title: "Быстрые денежные <br/> переводы",
                    fast_desc: "Получайте или отправляйте деньги в считанные секунды из любой точки мира.",
                    card_title: "Переводы с карты <br/> на карту 24/7",
                    card_desc: "Совершайте переводы на карты ArCa, Visa или Mastercard любого банка."
                },
                systems: {
            ...
            cards_page: {
                ...
                "cards_label": "Карты",
                "details": "Подробнее",
                "filter_no_results": "Карты с этим фильтром не найдены",
                "tabs": {
                    "qarter": "Карты",
                    "spasarkum": "Обслуживание",
                    "social": "Социальные"
                }
            },
            translation1: {
                ...
                "tariffs": {
                    "tabs": {
                        "personal_loans": "Кредиты физлицам",
                        "business_loans": "Бизнес кредиты",
                        "cards": "Тарифы карт",
                        "deposits": "Тарифы вкладов",
                        "archive": "Архив"
                    },
                    "table_headers": {
                        "number": "#",
                        "feature": "Название условия",
                        "value": "Тариф / Условие"
                    },
                    "archive_section": {
                        "title": "Архив",
                        "info_label": "Необходимая информация",
                        "download_package": "Скачать архивный пакет (PDF)",
                ...
                "months": "мес.",
                "days": "дн.",
                "daily_interest": "Ежедневная процентная сумма *",
                "total_gross": "Общий процентный доход за весь срок вклада",
                "total_net": "Фактический чистый процентный доход за весь срок вклада",
                "tax_info": "Процентный доход по вкладу облагается подоходным налогом в размере 10%.",
                "repayment_type": "Способ погашения",
                "spring": "Дифференцированный",
                "annuity": "Аннуитетный",
                "calculate": "Рассчитать",
                "disclaimer": "Все расчеты носят приблизительный характер и не являются публичной офертой.",
                "results_title": "Результаты кредитного калькулятора",
                "amount": "Сумма",
                "total": "Итого",
                "month": "Месяц",
                "interest_amount": "Процент",
