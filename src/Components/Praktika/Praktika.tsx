...
//     const [viewMode, setViewMode] = useState<number>(2);
...
//         // Կարդում ենք տվյալները ըստ լեզվի՝ praktika/hy, praktika/en և այլն
//         const jobsRef = ref(db, `praktika/${lang}`); 
...
//                 {[
//                     { id: 'work', label: t('careers.tabs.work') },
//                     { id: 'internship', label: t('careers.tabs.internship') },
//                     { id: 'bridge', label: t('careers.tabs.bridge') }
//                 ].map((tab) => (
//                     <button
//                         key={tab.id}
//                         onClick={() => { 
...
//                             <h2 className="text-[35px] md:text-[45px] font-[1000] italic uppercase text-[#1a1a1a] leading-none mb-4">
//                                 {t('careers.work_at_evoca.title')}
//                             </h2>
//                             <p className="text-gray-500 font-medium italic">
//                                 {t('careers.work_at_evoca.subtitle')}
//                             </p>
//                         </div>
//                     </div>
//                 </div>
...
//                 {[
//                     { label: t('careers.features.motivated'), img: "https://www.evoca.am/images-cache/applicant_features/1/16194199747856/120x120.png" },
//                     { label: t('careers.features.purposeful'), img: "https://www.evoca.am/images-cache/applicant_features/1/16194205883017/120x120.png" },
//                     { label: t('careers.features.flexible'), img: "https://www.evoca.am/images-cache/applicant_features/1/16194206332591/120x120.png" },
//                     { label: t('careers.features.loving'), img: "https://www.evoca.am/images-cache/applicant_features/1/16194207496218/120x120.png" },
//                 ].map((item, i) => (
...
//                     <h3 className="text-2xl font-[1000] italic uppercase text-[#1a1a1a]">
//                         {t('careers.jobs_list.title')}
//                     </h3>
//                     <div className="hidden md:flex items-center gap-2 bg-[#f8f9fb] p-1.5 rounded-2xl border border-gray-100">
//                         <button onClick={() => setViewMode(2)} className={`p-2.5 rounded-xl transition-all ${viewMode === 2 ? 'bg-white shadow-sm text-[#6610f2]' : 'text-gray-300 hover:text-gray-400'}`}>
//                             <LayoutGrid size={20} />
//                         </button>
//                         <button onClick={() => setViewMode(3)} className={`p-2.5 rounded-xl transition-all ${viewMode === 3 ? 'bg-white shadow-sm text-[#6610f2]' : 'text-gray-300 hover:text-gray-400'}`}>
//                             <Grid3X3 size={20} />
//                         </button>
//                     </div>
//                 </div>
...
//                     </div>
//                 ) : (
//                     <motion.div layout className={`grid grid-cols-1 gap-6 ${viewMode === 2 ? 'md:grid-cols-2' : 'md:grid-cols-3'}`}>
//                         {jobs.map((job) => (
...
//                                 >
//                                     {t('common.details')} <ChevronRight size={18} />
//                                 </button>
//                             </div>
//                         ))}
//                     </motion.div>
...
//                         <h5 className="text-xl font-[1000] italic uppercase text-[#6610f2]">{t('careers.job_detail.description')}</h5>
//                         <p className="text-gray-500 text-lg font-medium italic leading-relaxed">{job.description}</p>
//                     </div>
//                     <div className="space-y-6">
//                         <h5 className="text-xl font-[1000] italic uppercase text-[#6610f2]">{t('careers.job_detail.responsibilities')}</h5>
...
//                     </div>
//                     <div className="space-y-6">
//                         <h5 className="text-xl font-[1000] italic uppercase text-[#6610f2]">{t('careers.job_detail.requirements')}</h5>
//                         <ul className="space-y-4">
...
//                         <h6 className="text-lg font-[1000] italic uppercase text-[#1a1a1a] mb-8">{t('careers.job_detail.sidebar_title')}</h6>
//                         <div className="space-y-8 mb-10">
//                             <div className="flex items-start gap-4">
//                                 <div className="bg-white p-3 rounded-2xl shadow-sm text-[#6610f2]"><MapPin size={20} /></div>
//                                 <div>
//                                     <p className="text-[10px] font-black uppercase text-gray-400">{t('careers.job_detail.location')}</p>
...
//                                 <div>
//                                     <p className="text-[10px] font-black uppercase text-gray-400">{t('careers.job_detail.deadline')}</p>
...
//         const universities = [
//             { name: t('careers.universities.ysu'), logo: "https://www.evoca.am/images-cache/partner_universities/1/16192503158745/120x120.jpg" },
//             { name: t('careers.universities.aua'), logo: "https://www.evoca.am/images-cache/partner_universities/1/16192501535211/120x120.jpg" },
//             { name: t('careers.universities.asue'), logo: "https://www.evoca.am/images-cache/partner_universities/1/16192504505443/120x120.jpg" },
//             { name: t('careers.universities.rau'), logo: "https://www.evoca.am/images-cache/partner_universities/1/16192505629164/120x120.jpg" }
//         ];

//         const steps = [
//             { id: 1, title: t('careers.internship_steps.step1.title'), content: t('careers.internship_steps.step1.content') },
//             { id: 2, title: t('careers.internship_steps.step2.title'), content: t('careers.internship_steps.step2.content') },
//             { id: 3, title: t('careers.internship_steps.step3.title'), content: t('careers.internship_steps.step3.content') },
//             { id: 4, title: t('careers.internship_steps.step4.title'), content: t('careers.internship_steps.step4.content') },
//             { id: 5, title: t('careers.internship_steps.step5.title'), content: t('careers.internship_steps.step5.content') }
//         ];
...
//                     <h3 className="text-2xl font-[1000] italic uppercase text-[#1a1a1a] mb-12">
//                         {t('careers.internship.partner_universities')}
//                     </h3>
...
//                         <h3 className="text-4xl md:text-5xl font-[1000] italic uppercase text-center text-[#6610f2] mb-12">
//                             {t('careers.form.title')}
//                         </h3>
//                         <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
//                             <input type="text" className="w-full bg-white border border-gray-100 p-4 rounded-xl outline-none focus:border-[#6610f2]" placeholder={t('careers.form.first_name')} />
//                             <input type="text" className="w-full bg-white border border-gray-100 p-4 rounded-xl outline-none focus:border-[#6610f2]" placeholder={t('careers.form.last_name')} />
...
//                                 <input type="tel" className="flex-1 p-4 outline-none" placeholder={t('careers.form.phone')} />
//                             </div>
//                             <input type="email" className="md:col-span-2 w-full bg-white border border-gray-100 p-4 rounded-xl outline-none focus:border-[#6610f2]" placeholder={t('careers.form.email')} />
//                             <div className="md:col-span-2 space-y-2">
//                                 <label className="text-xs font-black uppercase text-gray-400">{t('careers.form.cv_label')}</label>
...
//                                     <p className="text-sm text-gray-400 group-hover:text-[#6610f2]">{t('careers.form.cv_upload')}</p>
//                                 </div>
//                             </div>
//                             <div className="md:col-span-2 flex items-center gap-4 bg-white p-4 rounded-xl border border-gray-100">
//                                 <input type="text" className="w-24 border border-gray-100 p-3 rounded-lg text-sm outline-none" placeholder={t('careers.form.captcha')} />
...
//                                 <button type="submit" className="bg-[#6610f2] text-white px-16 py-4 rounded-full font-[1000] uppercase italic tracking-wider shadow-lg hover:bg-[#520dc2] transition-all">
//                                     {t('common.send')}
//                                 </button>
//                             </div>
//                         </form>
